...
import { getNormalizedScrollLeft, detectScrollType } from 64531;
...
const nonRtlCharRegex = /[^\u0000-\u0040\u005B-\u0060\u007B-\u00BF\u00D7\u00F7\u02B9-\u02FF\u2000-\u200E\u2010-\u2029\u202C\u202F-\u2BFF]/;
const rtlCharRegex = /[\u0590-\u07FF\u200F\u202B\u202E\uFB1D-\uFDFD\uFE70-\uFEFC]/;

function stripLTRMarks(str) {
  return str !== '' && isRtl() && str !== null ? str.replace(stripMarksRegex, '') : str;
}
...
function forceLTRStr(str) {
  return str !== '' && isRtl() && str !== null ? ltrMarkSsr + str + ltrMark : str;
}
