...
e => {
    e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 14" width="16" height="14"><path fill="currentColor" fill-rule="evenodd" d="M4.6 1.5 1.64 7l2.96 5.5h6.8L14.36 7 11.4 1.5H4.6ZM15.5 7 12 .5H4L.5 7 4 13.5h8L15.5 7ZM8 8.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm0 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/></svg>'
}
//77067
e => {
...
e => {
    ...
    e.exports = {
        ...
        row: "row-y5H41VPj",
        "price-axis-currency-label-fade": "price-axis-currency-label-fade-y5H41VPj",
...
e => {
    ...
    e.exports = {
        ...
        gearheight: "13px",
        gearwidth: "15px",
        "price-axis-stub": "price-axis-stub-t9vjEPyG",
        wrapper: "wrapper-t9vjEPyG",
        label: "label-t9vjEPyG",
        symbol: "symbol-t9vjEPyG",
        gear: "gear-t9vjEPyG",
        "fixed-gear": "fixed-gear-t9vjEPyG",
        "fixed-symbol": "fixed-symbol-t9vjEPyG"
    }
}
